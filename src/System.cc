    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false)
{
    ...
    const char* model_path = "/home/wangyin/main/Downloads/ORB_SLAM3/line/SOLD2.onnx";

    psession = Ort::Session session(env, model_path, session_options);
    cout << "load onnx model "<< endl;
    ...
    // TODO add session
    mpTracker = new Tracking(this, session, mpVocabulary, mpFrameDrawer, mpMapDrawer,
...
cv::Mat System::TrackMonocular(const cv::Mat &im, const double &timestamp, const vector<IMU::Point>& vImuMeas, string filename)
{
    ...
    cv::Mat Tcw = mpTracker->GrabImageMonocular(im, session,timestamp,filename);
